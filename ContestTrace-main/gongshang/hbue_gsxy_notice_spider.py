...
列表：https://gsxy.hbue.edu.cn/2731/list.htm

调度示例：
  python d:\\xiangmu\\ConTest11\\gongshang\\hbue_gsxy_notice_spider.py --mode incremental

全量：
  python hbue_gsxy_notice_spider.py --mode full
...
BASE_URL = "https://gsxy.hbue.edu.cn"
LIST_PREFIX = "/2731/list"
SOURCE_DEFAULT = "工商管理学院"
CATEGORY = "通知公告"
SPIDER_NAME = "hbue_gsxy_notice_spider"
...
def main() -> None:
    ap = argparse.ArgumentParser(description="湖北经济学院工商管理学院通知公告爬虫")
