# -*- coding: utf-8 -*-
"""
针对湖北经济学院工商管理学院 · 通知公告（已入库的 title + content）提取并回写字段，不请求网络。
...
同时更新 updated_at。默认仅处理 spider_name = hbue_gsxy_notice_spider 的记录。
...
from hbue_gsxy_notice_spider import DEFAULT_DB_PATH, SPIDER_NAME
...
# ---------------------------------------------------------------------------
# 主题标签（工商管理学院通知常见主题）：(标签名, 触发词列表)
# ---------------------------------------------------------------------------

TAG_RULES: list[tuple[str, tuple[str, ...]]] = [
    ("双创实践", ("双创", "创新创业", "科创", "创业")),
    ("团学评优", ("五四", "团支部", "团总支", "评优", "先进")),
    ("奖学金资助", ("奖学金", "助学金", "国家奖学金")),
    ("评选公示", ("公示", "拟推荐", "初评", "评审结果")),
    ("党员发展", ("党员", "入党", "预备党员", "发展对象")),
    ("教学教务", ("教学", "课程", "考试", "培养方案", "选课")),
    ("招生就业", ("招生", "就业", "实习", "招聘")),
    ("党建思政", ("党建", "思政", "党支部")),
    ("材料申报", ("申报", "提交材料", "报名表")),
