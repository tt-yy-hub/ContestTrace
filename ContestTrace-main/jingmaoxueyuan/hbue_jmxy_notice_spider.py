# -*- coding: utf-8 -*-
"""
湖北经济学院经济与贸易学院 · 通知公告爬虫

调度：Windows「任务计划程序」每周一 09:00 执行：
  python d:\\xiangmu\\ConTest11\\hbue_jmxy_notice_spider.py --mode incremental
...
BASE_URL = "https://jmxy.hbue.edu.cn"
LIST_PREFIX = "/2195/list"
SOURCE_DEFAULT = "经济与贸易学院"
CATEGORY = "通知公告"
...
def main() -> None:
    ap = argparse.ArgumentParser(description="经济与贸易学院通知公告爬虫")
