# -*- coding: utf-8 -*-
"""
针对湖北经济学院经济与贸易学院 · 通知公告（已入库的 title + content）提取并回写字段，不请求网络。
...
同时更新 updated_at。默认仅处理 spider_name = hbue_jmxy_notice_spider 的记录。
...
from hbue_jmxy_notice_spider import DEFAULT_DB_PATH, SPIDER_NAME
...
# ---------------------------------------------------------------------------
# 主题标签（经贸学院通知常见主题）：(标签名, 触发词列表)，标题或全文任一命中即打上该标签
# ---------------------------------------------------------------------------

TAG_RULES: list[tuple[str, tuple[str, ...]]] = [
    ("奖学金资助", ("奖学金", "助学金", "励志奖学金", "国家奖学金", "藏龙学子")),
    ("评选公示", ("公示", "拟推荐", "初评", "评审结果", "评选结果", "考核结果")),
    ("荣誉称号", ("十佳", "五四", "优秀个人", "先进集体", "先进个人", "优秀团员", "优秀研究生导师")),
    ("竞赛活动", ("竞赛", "大赛", "挑战赛", "比赛")),
    ("教学教务", ("教学", "课程", "学业", "选课", "考试", "培养方案")),
    ("学工队伍", ("班主任", "辅导员", "文明寝室", "特色寝室")),
    ("师资人事", ("职称", "教职工", "台籍", "台湾籍")),
    ("党建思政", ("党建", "清廉", "思政", "团支部")),
