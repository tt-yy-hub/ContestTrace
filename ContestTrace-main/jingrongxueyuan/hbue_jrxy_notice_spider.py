...
列表：https://jrxy.hbue.edu.cn/tzgg/list.htm

调度：Windows「任务计划程序」每周一 09:00 执行：
  python d:\\xiangmu\\ConTest11\\jingrongxueyuan\\hbue_jrxy_notice_spider.py --mode incremental

全量（指定日期窗口内）：
  python hbue_jrxy_notice_spider.py --mode full
...
BASE_URL = "https://jrxy.hbue.edu.cn"
LIST_PREFIX = "/tzgg/list"
SOURCE_DEFAULT = "金融学院"
CATEGORY = "通知公告"
SPIDER_NAME = "hbue_jrxy_notice_spider"
...
def main() -> None:
    ap = argparse.ArgumentParser(description="湖北经济学院金融学院通知公告爬虫")
