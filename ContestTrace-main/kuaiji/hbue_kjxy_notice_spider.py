...
列表：https://kjxy.hbue.edu.cn/1679/list.htm

调度示例：
  python d:\\xiangmu\\ConTest11\\kuaiji\\hbue_kjxy_notice_spider.py --mode incremental

全量：
  python hbue_kjxy_notice_spider.py --mode full
...
BASE_URL = "https://kjxy.hbue.edu.cn"
LIST_PREFIX = "/1679/list"
SOURCE_DEFAULT = "会计学院"
CATEGORY = "通知公告"
SPIDER_NAME = "hbue_kjxy_notice_spider"
...
def main() -> None:
    ap = argparse.ArgumentParser(description="湖北经济学院会计学院通知公告爬虫")
