# -*- coding: utf-8 -*-
"""
湖北经济学院旅游与酒店管理学院 · 通知公告爬虫

列表：https://lyxy.hbue.edu.cn/110/list.htm

调度示例：
  python d:\\xiangmu\\ConTest11\\lvyoujiudian\\hbue_lyxy_notice_spider.py --mode incremental

全量：
  python hbue_lyxy_notice_spider.py --mode full
...
BASE_URL = "https://lyxy.hbue.edu.cn"
LIST_PREFIX = "/110/list"
SOURCE_DEFAULT = "旅游与酒店管理学院"
CATEGORY = "通知公告"
SPIDER_NAME = "hbue_lyxy_notice_spider"
...
def main() -> None:
    ap = argparse.ArgumentParser(description="湖北经济学院旅游与酒店管理学院通知公告爬虫")
