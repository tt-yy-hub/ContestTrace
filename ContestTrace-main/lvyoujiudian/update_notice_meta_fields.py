# -*- coding: utf-8 -*-
"""
针对湖北经济学院旅游与酒店管理学院 · 通知公告（已入库的 title + content）提取并回写字段，不请求网络。
...
同时更新 updated_at。默认仅处理 spider_name = hbue_lyxy_notice_spider 的记录。
...
from hbue_lyxy_notice_spider import DEFAULT_DB_PATH, SPIDER_NAME
...
# ---------------------------------------------------------------------------
# 主题标签（旅游与酒店管理学院通知常见主题）：(标签名, 触发词列表)
# ---------------------------------------------------------------------------

TAG_RULES: list[tuple[str, tuple[str, ...]]] = [
    ("志愿服务实践", ("志愿", "志愿服务", "植树", "社区", "实践")),
    ("团学党建", ("团支部", "团总支", "团员", "党员", "入党", "党建")),
    ("评选公示", ("公示", "拟推荐", "初评", "评审结果", "评选")),
    ("奖学金资助", ("奖学金", "助学金", "国家奖学金")),
    ("教学教务", ("教学", "课程", "考试", "培养方案", "学风")),
    ("实习就业", ("实习", "就业", "酒店", "会展", "旅游")),
    ("活动文体", ("举办", "活动", "趣味", "运动会", "联谊")),
    ("材料申报", ("申报", "提交材料", "报名表")),
