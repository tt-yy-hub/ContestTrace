...
列表：https://etc.hbue.edu.cn/xkjs_10388/list.htm

调度示例：
  python d:\\xiangmu\\ConTest11\\shiyanjiaoxue\\hbue_etc_notice_spider.py --mode incremental

全量：
  python hbue_etc_notice_spider.py --mode full
...
BASE_URL = "https://etc.hbue.edu.cn"
LIST_PREFIX = "/xkjs_10388/list"
SOURCE_DEFAULT = "实验教学中心"
CATEGORY = "通知公告"
SPIDER_NAME = "hbue_etc_notice_spider"
...
def main() -> None:
    ap = argparse.ArgumentParser(description="湖北经济学院实验教学中心通知公告爬虫")
