# -*- coding: utf-8 -*-
"""
针对湖北经济学院实验教学中心 · 通知公告（已入库的 title + content）提取并回写字段，不请求网络。
...
同时更新 updated_at。默认仅处理 spider_name = hbue_etc_notice_spider 的记录。
...
from hbue_etc_notice_spider import DEFAULT_DB_PATH, SPIDER_NAME
...
# ---------------------------------------------------------------------------
# 主题标签（实验教学中心通知常见主题）：(标签名, 触发词列表)
# ---------------------------------------------------------------------------

TAG_RULES: list[tuple[str, tuple[str, ...]]] = [
    ("实验室安全", ("实验室安全", "危化品", "化学品", "消防", "应急演练", "安全隐患")),
    ("仪器设备", ("仪器设备", "资产", "采购", "验收", "报废", "维护")),
    ("开放实验", ("开放实验", "实验室开放", "预约", "门禁")),
    ("虚拟仿真", ("虚拟仿真", "仿真实验", "VR", "线上实验")),
    ("教学项目", ("教学项目", "教改", "一流课程", "精品课", "课程建设")),
    ("实验教学", ("实验教学", "实验课", "实训", "实践教学")),
    ("竞赛培训", ("竞赛", "大赛", "培训", "选拔赛")),
    ("检查评估", ("检查", "评估", "督查", "整改")),
    ("规章制度", ("管理办法", "规定", "细则", "制度")),
    ("奖学金资助", ("奖学金", "助学金", "资助")),
