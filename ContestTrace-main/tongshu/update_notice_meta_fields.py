# -*- coding: utf-8 -*-
"""
针对湖北经济学院统计与数学学院 · 通知公告（已入库的 title + content）提取并回写字段，不请求网络。
...
同时更新 updated_at。默认仅处理 spider_name = hbue_tsxy_notice_spider 的记录。
...
from hbue_tsxy_notice_spider import DEFAULT_DB_PATH, SPIDER_NAME
...
# ---------------------------------------------------------------------------
# 主题标签（统计与数学学院通知常见主题）：(标签名, 触发词列表)
# ---------------------------------------------------------------------------

TAG_RULES: list[tuple[str, tuple[str, ...]]] = [
    ("学术科研", ("学术", "科研", "课题", "论文", "学报")),
    ("数学建模", ("数学建模", "建模竞赛", "国赛", "美赛")),
    ("统计调查", ("统计", "调查", "抽样", "数据分析")),
    ("学科竞赛", ("竞赛", "大赛", "挑战杯", "数学竞赛")),
    ("考试安排", ("考试", "考场", "缓考", "补考", "四六级")),
    ("教学教务", ("选课", "开课", "教学", "课程", "培养方案")),
    ("研究生", ("研究生", "硕士", "博士", "导师")),
    ("毕业论文", ("毕业论文", "开题", "答辩", "学位论文")),
    ("奖学金资助", ("奖学金", "助学金", "资助")),
    ("招聘公示", ("招聘", "公示", "人才引进")),
    ("材料申报", ("申报", "提交材料", "报名表")),
