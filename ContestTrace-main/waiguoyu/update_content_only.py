# -*- coding: utf-8 -*-
"""
只更新 notices 表的 content 字段：按 url 重抓详情页，用当前正文提取规则生成纯文本后写回。
...
用法：
  ...
  python update_content_only.py --spider hbue_jmxy_notice_spider
"""
...
from hbue_jmxy_notice_spider import (
    DEFAULT_DB_PATH,
    DETAIL_DELAY_SEC,
    DETAIL_RETRIES,
