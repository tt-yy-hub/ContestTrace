# -*- coding: utf-8 -*-
"""
针对外国语学院学生公告（已入库的 title + content）提取并回写字段，不请求网络。
...
# ---------------------------------------------------------------------------
# 主题标签：可按项目需要自行编辑
# 规则为 (标签名, 触发词列表)，标题或全文任一命中即打上该标签
# ---------------------------------------------------------------------------

TAG_RULES: list[tuple[str, tuple[str, ...]]] = [
    ("竞赛活动", ("竞赛", "大赛", "挑战赛", "比赛", "杯", "演讲", "外研社", "国才杯", "英语竞赛")),
    ("考试通知", ("考试", "专四", "专八", "四级", "六级", "八级", "听力试音", "试音", "统测", "补考")),
    ("毕业相关", ("毕业", "毕业论文", "论文", "开题", "答辩", "实习")),
    ("评选公示", ("公示", "拟推荐", "初评", "评审结果", "评选结果")),
    ("材料申报", ("申报", "提交材料", "报名", "报名表", "申请材料")),
]
