...
列表：https://tw.hbue.edu.cn/31/list.htm

调度示例：
  python d:\\xiangmu\\ConTest11\\xiaotuanwei\\hbue_tw_notice_spider.py --mode incremental

全量：
  python hbue_tw_notice_spider.py --mode full
...
BASE_URL = "https://tw.hbue.edu.cn"
LIST_PREFIX = "/31/list"
SOURCE_DEFAULT = "校团委"
CATEGORY = "通知公告"
SPIDER_NAME = "hbue_tw_notice_spider"
...
def parse_list_page(html: str) -> tuple[list[ListItem], Optional[str]]:
    """校团委列表为 ul.wp_article_list / li.list_item（与金融学院等站相同模板）；兼容 ul.news_list。"""
...
def main() -> None:
    ap = argparse.ArgumentParser(description="湖北经济学院校团委通知公告爬虫")
