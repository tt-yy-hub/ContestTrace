# -*- coding: utf-8 -*-
"""
针对湖北经济学院校团委 · 通知公告（已入库的 title + content）提取并回写字段，不请求网络。

默认仅处理 spider_name = hbue_tw_notice_spider 的记录。
...
from hbue_tw_notice_spider import DEFAULT_DB_PATH, SPIDER_NAME
...
TAG_RULES: list[tuple[str, tuple[str, ...]]] = [
    ("团学建设", ("团支部", "团支书", "团员", "团校", "团干")),
    ("社会实践", ("社会实践", "暑期实践", "三下乡", "实践队")),
    ("志愿服务", ("志愿者", "志愿服务", "公益", "支教")),
    ("青马工程", ("青马", "青年马克思主义")),
    ("五四评优", ("五四", "红旗团委", "红旗团支部", "优秀团员")),
    ("社团活动", ("社团", "学生社团", "社联")),
    ("主题教育", ("主题团日", "团日活动", "学习二十大")),
    ("竞赛评选", ("评选", "大赛", "竞赛", "挑战杯")),
    ("创新创业", ("创新", "创业", "互联网+")),
    ("材料申报", ("申报", "提交材料", "报名表")),
