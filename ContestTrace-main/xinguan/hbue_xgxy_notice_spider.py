...
列表：https://xgxy.hbue.edu.cn/3988/list.htm

调度示例：
  python d:\\xiangmu\\ConTest11\\xinguan\\hbue_xgxy_notice_spider.py --mode incremental

全量：
  python hbue_xgxy_notice_spider.py --mode full
...
BASE_URL = "https://xgxy.hbue.edu.cn"
LIST_PREFIX = "/3988/list"
SOURCE_DEFAULT = "信息管理学院"
CATEGORY = "通知公告"
SPIDER_NAME = "hbue_xgxy_notice_spider"
...
def main() -> None:
    ap = argparse.ArgumentParser(description="湖北经济学院信息管理学院通知公告爬虫")
