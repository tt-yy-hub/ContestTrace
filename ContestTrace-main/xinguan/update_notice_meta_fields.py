# -*- coding: utf-8 -*-
"""
针对湖北经济学院信息管理学院 · 通知公告（已入库的 title + content）提取并回写字段，不请求网络。
...
同时更新 updated_at。默认仅处理 spider_name = hbue_xgxy_notice_spider 的记录。
...
from hbue_xgxy_notice_spider import DEFAULT_DB_PATH, SPIDER_NAME
