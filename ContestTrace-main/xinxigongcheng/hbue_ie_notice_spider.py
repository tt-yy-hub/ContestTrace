...
列表：https://ie.hbue.edu.cn/400/list.htm

调度示例：
  python d:\\xiangmu\\ConTest11\\xinxigongcheng\\hbue_ie_notice_spider.py --mode incremental

全量：
  python hbue_ie_notice_spider.py --mode full
...
BASE_URL = "https://ie.hbue.edu.cn"
LIST_PREFIX = "/400/list"
SOURCE_DEFAULT = "信息工程学院"
CATEGORY = "通知公告"
...
def main() -> None:
    ap = argparse.ArgumentParser(description="湖北经济学院信息工程学院通知公告爬虫")
