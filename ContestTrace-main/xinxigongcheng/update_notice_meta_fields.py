# -*- coding: utf-8 -*-
"""
针对湖北经济学院信息工程学院 · 通知公告（已入库的 title + content）提取并回写字段，不请求网络。
...
同时更新 updated_at。默认仅处理 spider_name = hbue_ie_notice_spider 的记录。
...
from hbue_ie_notice_spider import DEFAULT_DB_PATH, SPIDER_NAME
...
# ---------------------------------------------------------------------------
# 主题标签（信息工程学院通知常见主题）：(标签名, 触发词列表)
# ---------------------------------------------------------------------------

TAG_RULES: list[tuple[str, tuple[str, ...]]] = [
    ("人才招聘", ("招聘", "人才引进", "专任教师", "聘用")),
    ("评选公示", ("公示", "五四", "评优", "先进", "评选结果")),
    ("教学实践", ("实验", "实训", "课程", "教学", "寒假", "暑期")),
    ("学科竞赛", ("竞赛", "大赛", "挑战杯", "电子设计")),
    ("网络安全", ("网络安全", "网信", "安全")),
    ("师资培训", ("研修班", "培训", "双语", "师资")),
    ("奖学金资助", ("奖学金", "助学金", "国家奖学金")),
