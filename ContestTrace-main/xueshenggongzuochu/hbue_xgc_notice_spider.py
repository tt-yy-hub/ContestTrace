...
列表：https://xgc.hbue.edu.cn/1007/list1.htm（分页 list2.htm、list3.htm…）

调度示例：
  python d:\\xiangmu\\ConTest11\\xueshenggongzuochu\\hbue_xgc_notice_spider.py --mode incremental

全量：
  python hbue_xgc_notice_spider.py --mode full
...
BASE_URL = "https://xgc.hbue.edu.cn"
# 学生工作处：首页为 list1.htm（无 list.htm），翻页 list2、list3…
LIST_PREFIX = "/1007/list"
SOURCE_DEFAULT = "学生工作处"
CATEGORY = "通知公告"
SPIDER_NAME = "hbue_xgc_notice_spider"
...
def main() -> None:
    ap = argparse.ArgumentParser(description="湖北经济学院学生工作处通知公告爬虫")
