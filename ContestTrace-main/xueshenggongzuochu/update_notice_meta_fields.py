# -*- coding: utf-8 -*-
"""
针对湖北经济学院学生工作处 · 通知公告（已入库的 title + content）提取并回写字段，不请求网络。
...
同时更新 updated_at。默认仅处理 spider_name = hbue_xgc_notice_spider 的记录。

用法：
  cd xueshenggongzuochu
...
from hbue_xgc_notice_spider import DEFAULT_DB_PATH, SPIDER_NAME
...
# ---------------------------------------------------------------------------
# 主题标签（学生工作处通知常见主题）：(标签名, 触发词列表)
# ---------------------------------------------------------------------------

TAG_RULES: list[tuple[str, tuple[str, ...]]] = [
    ("奖助贷", ("奖学金", "助学金", "助学贷款", "国家励志", "困难补助")),
    ("评优评先", ("评优", "先进", "五四", "表彰", "荣誉称号")),
    ("心理健康", ("心理", "咨询", "辅导", "心理健康教育")),
    ("征兵入伍", ("征兵", "入伍", "退役", "兵役")),
    ("宿舍管理", ("宿舍", "寝室", "晚归", "违章电器")),
    ("违纪处分", ("处分", "违纪", "警告", "记过")),
    ("学生活动", ("活动", "报名", "选拔", "志愿者")),
