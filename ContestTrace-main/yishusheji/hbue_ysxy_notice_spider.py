...
列表：https://ysxy.hbue.edu.cn/xsjs/list.htm

调度示例：
  python d:\\xiangmu\\ConTest11\\yishusheji\\hbue_ysxy_notice_spider.py --mode incremental

全量：
  python hbue_ysxy_notice_spider.py --mode full
...
BASE_URL = "https://ysxy.hbue.edu.cn"
LIST_PREFIX = "/xsjs/list"
SOURCE_DEFAULT = "艺术设计学院"
CATEGORY = "通知公告"
SPIDER_NAME = "hbue_ysxy_notice_spider"
...
def main() -> None:
    ap = argparse.ArgumentParser(description="湖北经济学院艺术设计学院通知公告爬虫")
