...
class IexySpider(BaseSpider):
    ...
    def __init__(self):
        ...
        super().__init__(
            name="信息工程学院",
            base_url="https://ie.hbue.edu.cn/400/list.htm"
        )
                ...
                for item in items:
                    ...
                    if a_tag and 'href' in a_tag.attrs:
                        ...
                        if href.startswith('http'):
                            ...
                            if href.startswith('/'):
                                detail_url = f"https://ie.hbue.edu.cn{href}"
                            else:
                                detail_url = f"https://ie.hbue.edu.cn/{href}"
                        # 过滤掉非竞赛链接
                ...
                if 'list.htm' in current_url:
                    ...
                    if next_page and 'href' in next_page.attrs:
                        ...
                        if href.startswith('http'):
                            ...
                            if href.startswith('/'):
                                return f"https://ie.hbue.edu.cn{href}"
                            else:
                                return f"https://ie.hbue.edu.cn/{href}"
        except Exception as e:
