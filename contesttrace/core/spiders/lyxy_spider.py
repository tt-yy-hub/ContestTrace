...
class LyxySpider(BaseSpider):
    ...
    def __init__(self):
        ...
        super().__init__(
            name="旅游与酒店管理学院",
            base_url="https://lyxy.hbue.edu.cn/110/list.htm"
        )
                ...
                for item in items:
                    ...
                    if a_tag and 'href' in a_tag.attrs:
                        ...
                        if href.startswith('http'):
                            ...
                            if href.startswith('/'):
                                detail_url = f"https://lyxy.hbue.edu.cn{href}"
                            else:
                                detail_url = f"https://lyxy.hbue.edu.cn/{href}"
                        # 过滤掉非竞赛链接
                ...
                if 'list.htm' in current_url:
                    ...
                    if next_page and 'href' in next_page.attrs:
                        ...
                        if href.startswith('http'):
                            ...
                            if href.startswith('/'):
                                return f"https://lyxy.hbue.edu.cn{href}"
                            else:
                                return f"https://lyxy.hbue.edu.cn/{href}"
        except Exception as e:
